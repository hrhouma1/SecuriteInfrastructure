...
- [Lien vers cette section](#21-introduction-aux-fonctionnalités-avancées-du-pare-feu-windows)
- Fonctionnalités abordées : règles de filtrage, inspection des paquets, journaux, et intégration avec IPSec.

---

### 2.2. Configuration des règles de sécurité pour la protection du réseau
- [Lien vers cette section](#22-configuration-des-règles-de-sécurité-pour-la-protection-du-réseau)
- Comprend des exemples de règles entrantes et sortantes pour sécuriser le réseau.

---

### 2.3. Application des stratégies de filtrage du trafic réseau
- [Lien vers cette section](#23-application-des-stratégies-de-filtrage-du-trafic-réseau)
- Filtrage par ports, protocoles, et politiques de sécurité.

---

### 2.4. Surveillance et gestion des journaux du pare-feu
- [Lien vers cette section](#24-surveillance-et-gestion-des-journaux-du-pare-feu)
- Comment activer et analyser la journalisation du pare-feu.
...
1. [Correction pour la version Linux](#correction-de-lexercice-pratique-version-linux)
2. [Correction pour la version Windows](#correction-de-lexercice-pratique-version-windows)
